...
import { MessageSquare, Bell, Target, BarChart } from "lucide-react"

const features = [
  {
    title: "Personalized Nudges",
    description: "Create targeted messages based on user behavior and role.",
    icon: MessageSquare,
  },
  {
    title: "Multi-channel Delivery",
    description: "Send nudges via email, Slack, or in-app notifications.",
    icon: Bell,
  },
  {
    title: "Smart Targeting",
    description: "Target specific teams or user segments for maximum impact.",
    icon: Target,
  },
  {
    title: "Effectiveness Analytics",
    description: "Track nudge performance and optimize your strategy.",
    icon: BarChart,
  },
]
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          >
            Personalized nudges and communications that actually drive adoption.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div className="aspect-[16/9] relative">
              <Image
                src="/nudge-engine-preview.png"
                alt="Nudge Engine Preview"
                fill
